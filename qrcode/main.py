...
def QR_With_FullBackground_Img(
    link="https://jobs8.cn:9000",
...
def QR_Single_Code(
    link="https://jobs8.cn:9000/", outputput_file="output_code_simple.png"
):
    # 简单的二维码
    # 生成二维码实例，设置大小和边框
...
if __name__ == "__main__":
    ...
    url = "https://download.hanlee.net:3444"
    QR_With_FullBackground_Img(
        link=url,
        background_picture="BackgroundIMG.png",
        outputput_file="output_code_with_background_png.png",
    )
    ...
    # outputput_file: output filename
    QR_Single_Code(
        link="itms-services://?action=download-manifest&url=https://jobs8.cn:9000/download.plist",
